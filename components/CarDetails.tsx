                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            ...
                            overflow-y-auto transform rounded-2xl p-6
                            bg-white text-left shadow-xl transition-all flex-col gap-5'
                            >
                                <button 
                                    className='absolute top-2 right-2 w-fit  rounded-full z-10'
                                    onClick={closeModal}
                                    type='button' 
                                >
